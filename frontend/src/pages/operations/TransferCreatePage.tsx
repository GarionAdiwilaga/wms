...
import { Trash2, ArrowLeft, ArrowLeftRight, Image as ImageIcon, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <PageHeader
          ...
          description="Formulir pengiriman dan transfer stock barang antar-cabang."
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="bg-card border border-border rounded-xl p-5 shadow-sm space-y-4 min-h-[300px]">
            ...
            {items.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center text-slate-500">
                <ArrowLeftRight className="h-12 w-12 mb-3 text-slate-400 dark:text-slate-700" />
        ...
        <div className="space-y-6">
          <form onSubmit={handleSaveDraft} className="bg-card border border-border rounded-xl p-5 shadow-sm space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="source_branch" className="text-slate-700 dark:text-slate-300">Cabang Asal</Label>
              {isSuperAdmin ? (
                <select
                  id="source_branch"
            ...
            {/* Destination Branch */}
            <div className="space-y-2">
              <Label htmlFor="dest_branch" className="text-slate-700 dark:text-slate-300">Cabang Tujuan</Label>
              <select
                id="dest_branch"
                name="dest_branch_id"
                value={destBranchId || ''}
            ...
            {/* Notes */}
            <div className="space-y-2">
              <Label htmlFor="notes" className="text-slate-700 dark:text-slate-300">Catatan Mutasi (Opsional)</Label>
              <textarea
                id="notes"
                name="notes"
