...
from app.api.v1.endpoints import auth, branch, category, supplier, uom, user, item, inventory, branch_stocks, stock_in, outbound, transfer, stock_opname, reports, dashboard, analytics
